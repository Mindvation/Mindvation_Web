...
class EfficiencyDiagram extends Component {
    ...
    getOption() {
        const graph = {
            ...
            "links": [{"id": "0", "name": null, "source": "1", "target": "0", "lineStyle": {"normal": {}}}, {
                "id": "1",
                "name": null,
                "source": "2",
                "target": "0",
    ...
    render() {
        return (
            <ECharts eChartId="efficiencyDiagram" option={this.getOption()}/>
        );
    }
}
